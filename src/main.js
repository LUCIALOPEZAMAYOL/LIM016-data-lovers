...
//Codigo para inicio de pantalla
...
btnCalcular.addEventListener('click', () => {   
  ...
  manipularGrafico(txtPoke1,txtPoke2,dataPoke1,dataPoke2);  // Paso datos 
});
...
//Creando elemento contenedor de grafico
  ...
  function manipularGrafico(txtPoke1,txtPoke2,dataPoke1,dataPoke2){
